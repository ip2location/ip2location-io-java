...
project = 'IP2Location.io Java SDK'
...
myst_html_meta = {
    "description": "IP2Location.io Java library allows user to query for an enriched data set based on IP address and provides WHOIS lookup api that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, Java, WHOIS, domain, hosted domain",
...
html_title = "IP2Location.io Java SDK"

# html_baseurl = "https://ip2location-io-java.readthedocs.io/en/latest/"