...
public class DomainWhois {
    private static final String BASE_URL = "https://api.ip2whois.com/v2";
    private static final String SOURCE = "sdk-java-iplio";
    private static final String FORMAT = "json";
    private static final String ERROR_WHOIS = "DomainWhois lookup error.";
    private static final String ERROR_DOMAIN = "DOMAIN NOT FOUND";
     ...
     */
    public DomainWhois(Configuration config) {
     ...
     */
    public JsonObject Lookup(String domain) throws Exception {
        String url = BASE_URL + "?format=" + FORMAT + "&source=" + SOURCE + "&source_version=" + configuration.getVersion() + "&key=" + configuration.getApiKey() + "&domain=" + URLEncoder.encode(domain, "UTF-8");
     ...
     */
    public String toPunycode(String domain) {
     ...
     */
    public String toNormalText(String domain) {
     ...
     */
    public String toDomainName(String url) {
        ...
        try {
            ...
            while (count > 0) {
                ...
                if (Arrays.asList(tlds).contains(domain)) {
                    return host;
                }
                count--;
     ...
     */
    public String toDomainExtension(String str) {
        var domain = toDomainName(str);
